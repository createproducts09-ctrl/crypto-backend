...
DEFAULT_FROM = "Alphora Labs <onboarding@resend.dev>"
...
def send_verification_email(to: str, username: str, code: str) -> dict[str, Any]:
    subject = "Verify your Alphora Labs email"
    html = f"""
    <div style="font-family: -apple-system, BlinkMacSystemFont, Segoe UI, sans-serif; max-width: 520px; margin: 0 auto; color: #0f172a;">
      ...
      <p style="color:#475569; line-height:1.5;">
        Welcome to Alphora Labs. Enter this code in the app to verify your email:
      </p>
      <p style="font-size: 32px; letter-spacing: 8px; font-weight: 700; margin: 24px 0; color:#0E7C74;">
        {code}
      </p>
      <p style="color:#64748b; font-size: 13px;">This code expires in 24 hours. If you didn’t create an Alphora Labs account, you can ignore this email.</p>
    </div>
    """
    text = f"Hi {username},\n\nYour Alphora Labs verification code is: {code}\nIt expires in 24 hours.\n"
    return send_email(to=to, subject=subject, html=html, text=text)


def send_welcome_email(to: str, username: str) -> dict[str, Any]:
    subject = "Thank you for downloading Alphora Labs"
    html = f"""
    <div style="font-family: -apple-system, BlinkMacSystemFont, Segoe UI, sans-serif; max-width: 520px; margin: 0 auto; color: #0f172a;">
      <h1 style="font-size: 22px; margin-bottom: 8px;">We’re glad you’re here</h1>
      <p style="color:#475569; line-height:1.5;">Hi {username},</p>
      <p style="color:#475569; line-height:1.5;">
        Thank you for downloading Alphora Labs. We’re grateful you chose us to explore crypto research —
      ...
      <p style="color:#0E7C74; font-weight: 600; margin-top: 28px;">— The Alphora Labs team</p>
    </div>
    """
    text = (
        f"Hi {username},\n\n"
        "Thank you for downloading Alphora Labs. We’re grateful you chose us for crypto research.\n\n"
        "— The Alphora Labs team\n"
    )
    return send_email(to=to, subject=subject, html=html, text=text)
